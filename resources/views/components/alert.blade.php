...
<div x-data="alertComponent()" x-show="show" x-transition.opacity.duration.300ms x-init="$store.alert.init()"
  class="position-fixed" style="top: 20px; right: 20px; z-index: 9999; min-width: 300px; max-width: 500px;" x-cloak>
  <div class="alert alert-dismissible fade show shadow-lg" :class="alertClass" role="alert">
