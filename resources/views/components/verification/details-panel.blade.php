        ...
        <div class="card">
            ...
            <div class="card-body">
                <ul class="nav nav-tabs" role="tablist">
                    <template x-for="(resourceType, index) in allResources"
                        :key="resourceType">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" :class="{ 'active': index === 0 }" :id="`${resourceType}-tab`"
                                ...
                                role="tab" x-text="resourceType.charAt(0).toUpperCase() + resourceType.slice(1).toLowerCase()">
                            </button>
                        </li>
                    </template>
                </ul>
                    ...
                    <template x-for="(resourceType, index) in allResources"
                        ...
                        <div class="tab-pane fade" :class="{ 'show active': index === 0 }"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <ul class="list-unstyled">
                                        <li>
                                            ...
                                            <span
                                                x-text="verificationCounts[resourceType]?.total || 0"></span>
                                        </li>
                                        <li>
                                ...
                                <div class="col-md-6">
                                    <h6>Common Issues</h6>
                                    <template x-if="(verificationCounts[resourceType]?.{{ \App\Enums\VerificationStatus::FAILED }} || 0) > 0">
                                        <ul class="list-group list-group-flush">
                                            <li class="list-group-item px-0 py-1">
                                                <small x-text="`${verificationCounts[resourceType]?.{{ \App\Enums\VerificationStatus::FAILED }} || 0} verification failures found`"></small>
                                            </li>
                                        </ul>
                                    </template>
                                    <template x-if="(verificationCounts[resourceType]?.{{ \App\Enums\VerificationStatus::FAILED }} || 0) === 0">
