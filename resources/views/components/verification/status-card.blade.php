  ...
  <div class="card-body">
    ...
    <div class="mb-3">
      ...
      <div class="progress" style="height: 20px;">
        <div class="progress-bar progress-bar-striped" role="progressbar" :style="`width: ${getProcessingProgress()}%`"
          :class="getProcessingBarClass()" x-text="`${getProcessingProgress()}%`">
        </div>
      </div>
    </div>
          ...
          <div class="mb-2">
            ...
            <div class="progress" style="height: 6px;">
              <div class="progress-bar"
                :class="(verificationCounts[resourceType]?.total > 0 && ((verificationCounts[resourceType]?.VERIFIED || 0) + (
                    verificationCounts[resourceType]?.FAILED || 0)) === verificationCounts[resourceType]?.total) ?
                'bg-success' : 'bg-info'"
                role="progressbar"
    ...
    <div class="row text-center mt-3">
      ...
      <div class="col-md-3">
        <div class="h5 mb-0 text-danger" x-text="(totalCounts.FAILED || 0).toLocaleString()"></div>
