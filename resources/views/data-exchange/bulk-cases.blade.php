            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <ul class="small">
                        ...
                        <li><strong>case_type:</strong> Individual Support, Family Support, Crisis Intervention, Assessment,
        ...
        function generateFakeCasesCSV() {
            ...
            fetch('{{ route('data-exchange.generate-fake-data') }}', {
                ...
                .then(blob => {
                    ...
                    statusDiv.innerHTML =
                        `<div class="alert alert-success alert-sm"><i class="fas fa-check"></i> Generated ${count} fake case records!</div>`;
