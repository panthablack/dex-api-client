...
@section('content')
    <div x-data="migrationApp()" x-init="init()" x-cloak>
        ...
        <div class="card">
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <small class="text-muted"
                                            x-text="`Page ${batch.page_index || batch.batch_number}`"></small>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <small class="text-muted"
                                            x-text="formatDuration(batch.started_at, batch.completed_at)"></small>
                                    </td>
                                </tr>
                            </template>
                        </tbody>
            ...
            <!-- Error Modal -->
            <div class="modal fade" id="error-modal" tabindex="-1" aria-labelledby="errorModalLabel"
                aria-hidden="true">
