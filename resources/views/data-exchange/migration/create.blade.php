        ...
        <div class="mb-4">
          ...
          <div class="d-flex flex-column gap-3">
            <div class="form-check">
              <input type="radio" name="resource_type" value="CLIENTS" id="CLIENTS" class="form-check-input"
            ...
            <div class="form-check">
              <input type="radio" name="resource_type" value="CASES" id="CASES" class="form-check-input"
            ...
            <div class="form-check">
              <input type="radio" name="resource_type" value="CLOSED_CASES" id="CLOSED_CASES" class="form-check-input"
                {{ old('resource_type') == 'CLOSED_CASES' ? 'checked' : '' }} required>
            ...
            <div class="form-check">
              ...
              <label for="SHALLOW_CLOSED_CASE" class="form-check-label d-flex align-items-center">
                ...
                <span class="badge bg-warning ms-2">
                  Lightweight closed case data for enrichment
                </span>
              </label>
            </div>
            ...
            @if ($hasMigratedCases)
              ...
              <div class="form-check">
                <input type="radio" name="resource_type" value="CASE_CLIENTS" id="CASE_CLIENTS" class="form-check-input"
                  {{ old('resource_type') == 'CASE_CLIENTS' ? 'checked' : '' }} required>
            ...
            @else
              <div class="form-check">
                <input type="radio" name="resource_type" value="sessions" id="sessions" class="form-check-input"
                  disabled title="Sessions require migrated cases to be available">
