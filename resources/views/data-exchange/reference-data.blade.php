                ...
                <form id="referenceDataForm">
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="referenceType" name="referenceType">
                            ...
                            <option value="AboriginalOrTorresStraitIslanderOrigin">Aboriginal Or Torres Strait Islander Origin</option>
                            ...
                            <option value="MoneyBusinessCommunityEducationWorkshop">Money Business Community Education Workshop</option>
    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <div>
                    <button class="btn btn-outline-primary btn-sm" onclick="exportResults('json')" id="exportJsonBtn" style="display: none;">
                        <i class="fas fa-download"></i> Export JSON
                    </button>
                    <button class="btn btn-outline-success btn-sm ms-2" onclick="exportResults('csv')" id="exportCsvBtn" style="display: none;">
    ...
    if (data && typeof data === 'object') {
        ...
        if (items.length > 0) {
            ...
            items.forEach(item => {
                ...
                const description = item.Description || item.description || item.name || item.label || 'N/A';
...
function convertReferenceDataToCSV(data) {
    ...
    items.forEach(item => {
        ...
        const description = (item.Description || item.description || item.name || item.label || '').toString().replace(/"/g, '""');
        const additional = (item.AdditionalInfo || item.additional || item.notes || '').toString().replace(/"/g, '""');
