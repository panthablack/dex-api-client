            ...
            <form action="{{ route('data-exchange.submit-case') }}" method="POST">
              ...
              <div class="row mb-3">
                ...
                <div class="col-md-6">
                  ...
                  <select class="form-select @error('outlet_activity_id') is-invalid @enderror" id="outlet_activity_id"
                    name="outlet_activity_id" required>
              ...
              <div class="row mb-3">
                <div class="col-md-6">
                  ...
                  <input type="text" class="form-control @error('client_id') is-invalid @enderror" id="client_id"
                    name="client_id" value="{{ old('client_id') }}" placeholder="Leave empty for unidentified clients">
                  @error('client_id')
                    <div class="invalid-feedback">{{ $message }}</div>
                  @enderror
                ...
                <div class="col-md-6">
                  ...
                  <input type="number" class="form-control @error('total_unidentified_clients') is-invalid @enderror"
                    ...
                    value="{{ old('total_unidentified_clients', 1) }}" min="0" max="100" placeholder="1">
                ...
                <div class="col-md-6">
                  ...
                  <select class="form-select @error('referral_source_code') is-invalid @enderror"
                    ...
                    @if (isset($referralSources) && !empty($referralSources))
                      ...
                      @endforeach
                    @else
                      <option value="COMMUNITY" {{ old('referral_source_code') == 'COMMUNITY' ? 'selected' : '' }}>
                        Community
                        services agency</option>
                      <option value="SELF" {{ old('referral_source_code') == 'SELF' ? 'selected' : '' }}>Self</option>
                      <option value="FAMILY" {{ old('referral_source_code') == 'FAMILY' ? 'selected' : '' }}>Family
                      </option>
                      <option value="GP" {{ old('referral_source_code') == 'GP' ? 'selected' : '' }}>
                        General Medical Practitioner</option>
                      <option value="HealthAgency" {{ old('referral_source_code') == 'HealthAgency' ? 'selected' : '' }}>
                        Health
                        Agency</option>
                    @endif
                  </select>
              ...
              <div class="row mb-3">
                <div class="col-md-6">
                  ...
                  <input type="date" class="form-control @error('end_date') is-invalid @enderror" id="end_date"
                    name="end_date" value="{{ old('end_date') }}" min="{{ date('Y-m-d', strtotime('-60 days')) }}"
                ...
                <div class="col-md-6">
                  ...
                  <select class="form-select @error('exit_reason_code') is-invalid @enderror" id="exit_reason_code"
                    ...
                    @else
                      <option value="MOVED" {{ old('exit_reason_code') == 'MOVED' ? 'selected' : '' }}>
                        Moved</option>
                      <option value="COMPLETED" {{ old('exit_reason_code') == 'COMPLETED' ? 'selected' : '' }}>Completed
                      </option>
                      <option value="VOLUNTARY" {{ old('exit_reason_code') == 'VOLUNTARY' ? 'selected' : '' }}>Voluntary
                      </option>
              ...
              <div class="row mb-3">
                <div class="col-md-6">
                  ...
                  <input type="text" class="form-control @error('ag_business_type_code') is-invalid @enderror"
                    id="ag_business_type_code" name="ag_business_type_code" value="{{ old('ag_business_type_code') }}"
                    maxlength="10">
