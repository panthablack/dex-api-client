            ...
            <form action="{{ route('data-exchange.submit-client') }}" method="POST">
              ...
              <div class="row mb-3">
                <div class="col-md-6">
                  ...
                  <select class="form-select @error('indigenous_status') is-invalid @enderror" id="indigenous_status"
                ...
                <div class="col-md-6">
                  ...
                  <select class="form-select @error('country_of_birth') is-invalid @enderror" id="country_of_birth"
              ...
              <div class="row mb-3">
                <div class="col-md-4">
                  ...
                  <input type="text" class="form-control @error('suburb') is-invalid @enderror" id="suburb"
                    name="suburb" value="{{ old('suburb') }}" required>
                  @error('suburb')
                    <div class="invalid-feedback">{{ $message }}</div>
                  @enderror
                </div>
              ...
              <div class="row mb-3">
                <div class="col-md-6">
                  ...
                  <select class="form-select @error('primary_language') is-invalid @enderror" id="primary_language"
              ...
              <div class="row mb-3">
                <div class="col-md-6">
                  <div class="form-check">
                    <input class="form-check-input" type="checkbox" id="interpreter_required"
                      name="interpreter_required" value="1" {{ old('interpreter_required') ? 'checked' : '' }}>
                ...
                <div class="col-md-6">
                  <div class="form-check">
                    <input class="form-check-input" type="checkbox" id="disability_flag" name="disability_flag"
                      value="1" {{ old('disability_flag') ? 'checked' : '' }}>
              ...
              <div class="row mb-3">
                <div class="col-md-6">
                  <div class="form-check">
                    <input class="form-check-input" type="checkbox" id="is_using_psuedonym" name="is_using_psuedonym"
                      value="1" {{ old('is_using_psuedonym') ? 'checked' : '' }}>
