                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select @error('client_type') is-invalid @enderror" 
                                ...
                                <option value="Family" {{ old('client_type') == 'Family' ? 'selected' : '' }}>Family</option>
                                <option value="Group" {{ old('client_type') == 'Group' ? 'selected' : '' }}>Group</option>
                            </select>
                            @error('client_type')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select @error('gender') is-invalid @enderror" 
                                ...
                                <option value="X" {{ old('gender') == 'X' ? 'selected' : '' }}>Non-binary</option>
                                <option value="9" {{ old('gender') == '9' ? 'selected' : '' }}>Not stated</option>
                            </select>
                            @error('gender')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
