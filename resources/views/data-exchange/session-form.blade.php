            ...
            <form action="{{ route('data-exchange.submit-session') }}" method="POST">
              ...
              <div class="row mb-3">
                <div class="col-md-6">
                  ...
                  <input type="text" class="form-control @error('session_id') is-invalid @enderror" id="session_id"
                    name="session_id" value="{{ old('session_id') }}" required>
                  @error('session_id')
                ...
                <div class="col-md-6">
                  ...
                  <input type="text" class="form-control @error('case_id') is-invalid @enderror" id="case_id"
                    name="case_id" value="{{ old('case_id') }}" required>
                  @error('case_id')
                    <div class="invalid-feedback">{{ $message }}</div>
                  @enderror
                </div>
              ...
              <div class="row mb-3">
                <div class="col-md-6">
                  ...
                  <select class="form-select @error('service_type_id') is-invalid @enderror" id="service_type_id"
                ...
                <div class="col-md-6">
                  ...
                  <select class="form-select @error('session_status') is-invalid @enderror" id="session_status"
                    name="session_status">
                    ...
                    <option value="Cancelled" {{ old('session_status') == 'Cancelled' ? 'selected' : '' }}>
                      Cancelled</option>
                    <option value="No Show" {{ old('session_status') == 'No Show' ? 'selected' : '' }}>
                      No
                      Show</option>
                    <option value="In Progress" {{ old('session_status') == 'In Progress' ? 'selected' : '' }}>In
                      Progress
                    </option>
                    <option value="Rescheduled" {{ old('session_status') == 'Rescheduled' ? 'selected' : '' }}>
                      Rescheduled
                    </option>
                  </select>
              ...
              <div class="row mb-3">
                <div class="col-md-6">
                  ...
                  <input type="date" class="form-control @error('session_date') is-invalid @enderror" id="session_date"
                    name="session_date" value="{{ old('session_date') }}" required>
                  @error('session_date')
                    <div class="invalid-feedback">{{ $message }}</div>
                  @enderror
                </div>
              ...
              <div class="row mb-3">
                ...
                <div class="col-md-6">
                  ...
                  <input type="text" class="form-control @error('attendees') is-invalid @enderror" id="attendees"
                    name="attendees" value="{{ old('attendees') }}" placeholder="e.g., Client, Counsellor">
                  @error('attendees')
                    <div class="invalid-feedback">{{ $message }}</div>
                  @enderror
                </div>
              ...
              <div class="row mb-3">
                <div class="col-md-6">
                  ...
                  <select class="form-select @error('outcome') is-invalid @enderror" id="outcome" name="outcome">
                    <option value="">Select Outcome</option>
                    <option value="Positive" {{ old('outcome') == 'Positive' ? 'selected' : '' }}>
                      Positive
                    </option>
                    <option value="Neutral" {{ old('outcome') == 'Neutral' ? 'selected' : '' }}>
                      Neutral
                    </option>
                    <option value="Challenging" {{ old('outcome') == 'Challenging' ? 'selected' : '' }}>
                      Challenging</option>
                    <option value="Ongoing" {{ old('outcome') == 'Ongoing' ? 'selected' : '' }}>
                      Ongoing
                    </option>
                    <option value="Referred" {{ old('outcome') == 'Referred' ? 'selected' : '' }}>
                      Referred
                    </option>
