                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select @error('session_status') is-invalid @enderror"
                                        ...
                                        <option value="Scheduled"
                                            {{ old('session_status') == 'Scheduled' ? 'selected' : '' }}>
                                            Scheduled</option>
                                        <option value="Completed"
                                            {{ old('session_status') == 'Completed' ? 'selected' : '' }}>
                                            Completed</option>
                                        <option value="Cancelled"
                                            {{ old('session_status') == 'Cancelled' ? 'selected' : '' }}>
                                            Cancelled</option>
                                        <option value="No Show" {{ old('session_status') == 'No Show' ? 'selected' : '' }}>
                                            No
                                            Show</option>
                                        <option value="In Progress"
                                            {{ old('session_status') == 'In Progress' ? 'selected' : '' }}>In Progress
                                        </option>
                                        <option value="Rescheduled"
                                            {{ old('session_status') == 'Rescheduled' ? 'selected' : '' }}>Rescheduled
                                        </option>
                                    </select>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select @error('outcome') is-invalid @enderror" id="outcome"
                                        ...
                                        <option value="Challenging"
                                            {{ old('outcome') == 'Challenging' ? 'selected' : '' }}>
                                            Challenging</option>
