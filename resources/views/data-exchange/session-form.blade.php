        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('data-exchange.submit-session') }}" method="POST">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <label for="session_id" class="form-label">Session ID <span class="text-danger">*</span></label>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <select class="form-select @error('session_type') is-invalid @enderror" 
                                ...
                                <option value="Individual Counselling" {{ old('session_type') == 'Individual Counselling' ? 'selected' : '' }}>Individual Counselling</option>
                                <option value="Group Counselling" {{ old('session_type') == 'Group Counselling' ? 'selected' : '' }}>Group Counselling</option>
                                <option value="Assessment" {{ old('session_type') == 'Assessment' ? 'selected' : '' }}>Assessment</option>
                                <option value="Support Group" {{ old('session_type') == 'Support Group' ? 'selected' : '' }}>Support Group</option>
                                <option value="Case Review" {{ old('session_type') == 'Case Review' ? 'selected' : '' }}>Case Review</option>
                                <option value="Therapy" {{ old('session_type') == 'Therapy' ? 'selected' : '' }}>Therapy</option>
                                <option value="Crisis Intervention" {{ old('session_type') == 'Crisis Intervention' ? 'selected' : '' }}>Crisis Intervention</option>
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select @error('session_status') is-invalid @enderror" 
                                ...
                                <option value="Cancelled" {{ old('session_status') == 'Cancelled' ? 'selected' : '' }}>Cancelled</option>
                                <option value="No Show" {{ old('session_status') == 'No Show' ? 'selected' : '' }}>No Show</option>
                                <option value="In Progress" {{ old('session_status') == 'In Progress' ? 'selected' : '' }}>In Progress</option>
                                <option value="Rescheduled" {{ old('session_status') == 'Rescheduled' ? 'selected' : '' }}>Rescheduled</option>
                            </select>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <select class="form-select @error('outcome') is-invalid @enderror" 
                                ...
                                <option value="Positive" {{ old('outcome') == 'Positive' ? 'selected' : '' }}>Positive</option>
                                <option value="Neutral" {{ old('outcome') == 'Neutral' ? 'selected' : '' }}>Neutral</option>
                                <option value="Challenging" {{ old('outcome') == 'Challenging' ? 'selected' : '' }}>Challenging</option>
                                ...
                                <option value="Completed" {{ old('outcome') == 'Completed' ? 'selected' : '' }}>Completed</option>
                            </select>
                            @error('outcome')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
