...
<div class="row mb-4">
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                <div id="connectionStatus" class="text-muted">Click "Test Connection" to check SOAP service availability</div>
    ...
    <div class="col-md-6 mb-4">
        <div class="card h-100">
            <div class="card-body text-center">
                ...
                <div class="d-grid gap-2">
                    <a href="{{ route('data-exchange.retrieve-form') }}" class="btn btn-success">Go to Data Retrieval</a>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li><strong>SOAP Version:</strong> <code>{{ config('soap.dss.soap_options.soap_version') == SOAP_1_2 ? '1.2' : '1.1' }}</code></li>
                            <li><strong>Organization ID:</strong> <code>{{ config('soap.dss.organisation_id') ?? 'Not configured' }}</code></li>
                        </ul>
                    </div>
                    <div class="col-md-6">
                        <h6>Features</h6>
