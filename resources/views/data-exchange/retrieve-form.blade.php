                ...
                <div class="card-body">
                    <form id="retrieveForm" action="{{ route('data-exchange.retrieve-data') }}" method="POST">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <select class="form-select @error('resource_type') is-invalid @enderror" id="resource_type"
                                    ...
                                    @foreach ($resources as $key => $label)
                                        <option value="{{ $key }}"
                                            {{ old('resource_type') == $key ? 'selected' : '' }}>
                                            {{ $label }}
                                        </option>
                                    @endforeach
                                    <option value="client_by_id"
                                        {{ old('resource_type') == 'client_by_id' ? 'selected' : '' }}>
                                        Get Client by ID
                                    </option>
                                    <option value="case_by_id" {{ old('resource_type') == 'case_by_id' ? 'selected' : '' }}>
                                        Get Case by ID
                                    </option>
                                    <option value="session_by_id"
                                        {{ old('resource_type') == 'session_by_id' ? 'selected' : '' }}>
                                        Get Session by ID
                                    </option>
                                </select>
                                @error('resource_type')
                            ...
                            <div class="col-md-6">
                                <label for="format" class="form-label">Output Format <span
                                        class="text-danger">*</span></label>
                        ...
                        <div id="requiredFiltersSection" style="display: none;">
                            ...
                            <div class="row mb-3" id="requiredClientFilters" style="display: none;">
                                <div class="col-md-6">
                                    <label for="req_client_id" class="form-label">Client ID <span
                                            class="text-danger">*</span></label>
                            ...
                            <div class="row mb-3" id="requiredCaseFilters" style="display: none;">
                                <div class="col-md-6">
                                    <label for="req_case_id" class="form-label">Case ID <span
                                            class="text-danger">*</span></label>
                                    <input type="text" class="form-control" id="req_case_id" name="case_id"
                            ...
                            <div class="row mb-3" id="requiredSessionFilters" style="display: none;">
                                <div class="col-md-6">
                                    <label for="req_session_id" class="form-label">Session ID <span
                                            class="text-danger">*</span></label>
                                    <input type="text" class="form-control" id="req_session_id" name="session_id"
                                        value="{{ old('session_id') }}" required>
                                </div>
                                <div class="col-md-6">
                                    <label for="req_session_case_id" class="form-label">Case ID <span
                                            class="text-danger">*</span></label>
