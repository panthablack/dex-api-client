    ...
    <div class="row">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('data-exchange.bulk-sessions-upload') }}" method="POST"
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <ul class="small">
                        ...
                        <li><strong>service_type_id:</strong> Individual Counselling, Group Counselling, Assessment, Support
                    ...
                    <div class="alert alert-info mt-3">
                        <small><strong>Note:</strong> Required fields: session_id, case_id, service_type_id, session_date,
        ...
        function bulkSessionsApp() {
            ...
            fetch('{{ route('data-exchange.generate-fake-data') }}', {
                ...
                .then(blob => {
                    ...
                    statusDiv.innerHTML =
                        `<div class="alert alert-success alert-sm"><i class="fas fa-check"></i> Generated ${count} fake session records!</div>`;
