    ...
    <div class="col-md-4 mb-4">
        <div class="card h-100">
            <div class="card-body text-center">
                ...
                <p class="card-text">Upload multiple client records from a CSV file with all required client information including address, demographics, and consent data</p>
    ...
    <div class="col-md-4 mb-4">
        <div class="card h-100">
            <div class="card-body text-center">
                ...
                <p class="card-text">Upload multiple case records from a CSV file with case management information, client assignments, and case details</p>
    ...
    <div class="col-md-4 mb-4">
        <div class="card h-100">
            <div class="card-body text-center">
                ...
                <p class="card-text">Upload multiple session records from a CSV file with session and service delivery data including duration, outcomes, and notes</p>
