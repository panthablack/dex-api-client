...
@section('content')
  <div x-data="enrichmentApp()" x-init="init()" x-cloak>
    <div class="d-flex justify-content-between align-items-center mb-4">
      <h1 class="h2 text-primary">Session Enrichment Dashboard</h1>
      <div class="btn-group">
        <!-- Start/Resume button -->
    ...
    @if (!$canEnrich)
      <div class="alert alert-warning" role="alert">
        ...
        <strong>Prerequisite Required:</strong> You must complete a <strong>SHALLOW_SESSION</strong> migration before you
        can enrich sessions.
        <a href="{{ route('data-migration.create') }}" class="alert-link">Create a SHALLOW_SESSION migration now</a>.
      </div>
    @endif
    ...
    <div class="card mb-4">
      <div class="card-body">
        ...
        <ul>
          <li><strong>Requires:</strong> A completed SHALLOW_SESSION migration to provide the list of session IDs</li>
          ...
          <li><strong>Stores:</strong> Full session data including client IDs, outlet details, and session information
          </li>
